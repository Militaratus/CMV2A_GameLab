    ...
    void Update()
    {
        if (heldObject)
        {
            ...
            if (controller.controller.GetPressUp(Valve.VR.EVRButtonId.k_EButton_SteamVR_Trigger))
            {
                ...
                heldObject.GetComponent<HeldObjects>().parent = null;
                heldObject = null;
            }
        }
        else
        {
            if (controller.controller.GetPressDown(Valve.VR.EVRButtonId.k_EButton_SteamVR_Trigger))
            {
                ...
                {
                    if (heldObject == null && col.GetComponent<HeldObjects>() && col.GetComponent<HeldObjects>().parent == null)
                    {
                        ...
                        heldObject.GetComponent<HeldObjects>().parent = controller;
                    }
                }
            }
         }
